					...
					<div class="side-app">
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Data Soal Direview</h4>
							</div>
												...
												<tbody>
													<?php
														...
														if (isset($_POST["sortSubmit"])) {
															$id_mapel = $_POST["sort"];
															$query = mysqli_query($conn, "select * from soal inner join mapel on soal.id_mapel=mapel.id_mapel inner join guru on soal.id_guru=guru.id_guru where status = 'DIREVIEW' AND soal.id_mapel = $id_mapel");
														} else {
															$query = mysqli_query($conn, "select * from soal inner join mapel on soal.id_mapel=mapel.id_mapel inner join guru on soal.id_guru=guru.id_guru where status = 'DIREVIEW'");
														}
