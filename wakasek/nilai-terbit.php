										...
										<div class="table-responsive">
											<table class="table table-bordered" id="example1">
												...
												<tbody>
													<?php
														$no = 0;
														$query = mysqli_query($conn, "select * from nilai inner join mapel on nilai.id_mapel=mapel.id_mapel inner join siswa on nilai.id_siswa=siswa.id_siswa where status = 'DITERBITKAN' order by id_nilai desc");
