							...
							function tanggal_indo($tanggal)
								{
									...
									return $split[2] . ' ' . $bulan[ (int)$split[1] ] . ' ' . $split[0];
											...
											if(isset($_POST['terbitkan'])){
												...
												} else $gagal 	= "<div class='alert alert-danger' role='alert'><strong>Oh snap! </strong>Terbitkan data nilai GAGAL ! Mohon periksa kembali</div>".mysqli_error($conn);
											}
										...
										<div class="table-responsive">
											<table class="table table-bordered" id="example1">
												...
												<tbody>
													<?php
														$no = 0;
														$query = mysqli_query($conn, "select * from nilai inner join mapel on nilai.id_mapel=mapel.id_mapel inner join siswa on nilai.id_siswa=siswa.id_siswa order by id_nilai desc");
