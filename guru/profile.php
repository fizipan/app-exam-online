										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												...
												<?php 
													...
													$dataGuru3 = mysqli_fetch_assoc($query3);
												?>
													<a href="profile.php" class="dropdown-item text-center user pb-0 font-weight-bold"><?php echo $dataGuru["nama_guru"] ?></a>
								...
								<div class="modal-dialog">
									...
									<div class="modal-body">
											...
											<div class="form-group">
												...
												<input type="number" name="nip" id="nip" class="form-control" value="<?= $dataGuru["nip"]; ?>">
											</div>
											<div class="form-group">
												<label for="nama">Nama</label>
												<input type="text" name="nama" id="nama" class="form-control" value="<?= $dataGuru["nama_guru"]; ?>">
											</div>
											<div class="form-group">
												<label for="id_mapel">Mata Pelajaran 1</label>
												<input type="text" id="id_mapel" name="id_mapel" class="form-control"  readonly value="<?= $dataGuru["nama_mapel"]; ?>" readonly>
												<input type="hidden" id="id_mapel" name="id_mapel" value="<?= $dataGuru["id_mapel"]; ?>">
											</div>
											<?php  if ($dataGuru["id_mapel2"] && $dataGuru["id_mapel3"]) : ?>
											<div class="form-group">
												<label for="id_mapel2">Mata Pelajaran 2</label>
												<input type="text" id="id_mapel2" name="id_mapel2" class="form-control"  readonly value="<?= $dataGuru2["nama_mapel"]; ?>">
												<input type="hidden" id="id_mapel2" name="id_mapel2" value="<?= $dataGuru["id_mapel2"]; ?>">
											</div>
											<div class="form-group">
												<label for="id_mapel3">Mata Pelajaran 3</label>
												<input type="text" id="id_mapel3" name="id_mapel3" class="form-control"  disabled value="<?= $dataGuru3["nama_mapel"]; ?>">
												<input type="hidden" id="id_mapel3" name="id_mapel3" value="<?= $dataGuru["id_mapel3"]; ?>">
											</div>
											<?php elseif($dataGuru["id_mapel2"]) : ?>
											<div class="form-group">
												<label for="id_mapel2">Mata Pelajaran 2</label>
												<input type="text" id="id_mapel2" name="id_mapel2" class="form-control"  disabled value="<?= $dataGuru2["nama_mapel"]; ?>">
												<input type="hidden" id="id_mapel2" name="id_mapel2" value="<?= $dataGuru["id_mapel2"]; ?>">
											</div>
											<?php elseif($dataGuru["id_mapel3"]) : ?>
											<div class="form-group">
												<label for="id_mapel3">Mata Pelajaran 2</label>
												<input type="text" id="id_mapel3" name="id_mapel3" class="form-control"  disabled value="<?= $dataGuru3["nama_mapel"]; ?>">
												<input type="hidden" id="id_mapel3" name="id_mapel3" value="<?= $dataGuru["id_mapel3"]; ?>">
											</div>
											<?php endif; ?>
											<div class="form-group">
												...
												<textarea name="alamat" id="alamat" class="form-control"><?= $dataGuru["alamat"]; ?></textarea>
											</div>
											<div class="form-group">
												<label for="no_hp">No HP</label>
												<input type="number" name="no_hp" id="no_hp" class="form-control" value="<?= $dataGuru["no_hp"]; ?>">
											</div>
										</div>
                                    ...
                                    <div class="card overflow-hidden dash1-card border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                ?>
                                                <div class="col-6">
                                                    <p>: <?php echo $dataGuru['nip'] ?></p>
                                                    <p>: <?php echo $dataGuru['nama_guru'] ?></p>
                                                    <p>: <?php echo $dataGuru['nama_mapel'] ?></p>
                                                <?php  if ($dataGuru["id_mapel2"] && $dataGuru["id_mapel3"]) : ?>
													<p>: <?= $dataGuru2["nama_mapel"]; ?></p>
													<p>: <?= $dataGuru3["nama_mapel"]; ?></p>
												<?php elseif($dataGuru["id_mapel2"]) : ?>
													<p>: <?= $dataGuru2["nama_mapel"]; ?></p>
												<?php elseif($dataGuru["id_mapel3"]) : ?>
													<p>: <?= $dataGuru3["nama_mapel"]; ?></p>
												<?php endif; ?>
                                                    <p>: <?php echo $dataGuru["alamat"] ?></p>
                                                    <p>: <?php echo $dataGuru["no_hp"] ?></p>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
