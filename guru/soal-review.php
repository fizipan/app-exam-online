												...
												<tbody>
													<?php
														...
														if (isset($_POST["sortSubmit"])) {
															...
															$query = mysqli_query($conn, "select * from soal inner join mapel on soal.id_mapel=mapel.id_mapel inner join guru on soal.id_guru=guru.id_guru where soal.id_mapel = $id_mapelSort and soal.status = 'DIREVIEW'");
														} else {
															$query = mysqli_query($conn, "select * from soal inner join mapel on soal.id_mapel=mapel.id_mapel inner join guru on soal.id_guru=guru.id_guru where soal.id_mapel = $id_mapel and soal.status = 'DIREVIEW'");
														}
