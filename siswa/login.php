							...
							<div class="">
								<div class="text-white">
									<div class="card-body">
										...
										<h4 class="text-white-80 mb-7 text-center">Siswa Login</h4>
										<?php 
											...
											if($row > 0){
												$sql1 		= "select * from kelas where id_kelas='".$rows['id_kelas']."'";
												$query1		= mysqli_query($conn, $sql1) or die (mysqli_error());
												$row1 = mysqli_fetch_array($query1);
												
												$_SESSION['isLoggedIn']=4;
												$_SESSION['nisn']=$nisn;
												$_SESSION['id_siswa']= $rows['id_siswa'];
												$_SESSION['id_kelas']= $rows['id_kelas'];
												$_SESSION['nama_siswa']= $rows['nama_siswa'];
												$_SESSION['alamat']= $rows['alamat'];
												$_SESSION['no_hp']= $rows['no_hp'];
												$_SESSION['tingkat_kelas']= $row1['tingkat_kelas'];
												...
												<p align='center'>Nomor Induk Siswa Nasional atau Password anda SALAH ! <br>silahkan ulangi kembali</p>
												</div>";
													}
												}
										...
										<div class="row">
											<div class="col-9 d-block mx-auto">
												<div class="input-group mb-4">
													...
													<input type="text" class="form-control" placeholder="Nomor Induk Siswa Nasional" name="nisn" required>
												</div>
												<div class="input-group mb-4">
													<div class="input-group-prepend">
														<div class="input-group-text">
