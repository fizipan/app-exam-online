				...
				<aside class="app-sidebar">
					...
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							...
							<div class="user-info">
								<h5 class=" mb-1"><?php echo $_SESSION['nama_siswa'] ?></h5>
										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="#" class="dropdown-item text-center user pb-0 font-weight-bold"><?php echo $_SESSION['nama_siswa'] ?></a>
								...
								<div class="card">
									...
									<div class="card-body">
										<?php
											...
											if(isset($sukses)) { echo $sukses; } if(isset($gagal)) { echo $gagal; }
										?>
										<p align="center"><a href="matpel.php" class="btn btn-info btn-rounded"><i class="fa fa-fw fa-backward"></i> KEMBALI KE MATA PELAJARAN</a></p>
									</div>
								</div>
							</div>
						</div>
