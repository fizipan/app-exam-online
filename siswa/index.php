					...
					<div class="side-app">
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Hai <?php echo $dataSiswa['nama_siswa'] ?> ! Selamat Datang Kembali</h4>
							</div>
							<div class="page-rightheader">
							</div>
						</div>
						<div class="row">
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12" align="center">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										<p class=" mb-1 ">TOTAL GURU</p>
										<?php
											$query = mysqli_query($conn, "select count(*) as hasil from guru");
											while ($row = mysqli_fetch_array($query)) {
										?>
										<h2 class="mb-1 number-font"><?php echo $row['hasil']; ?></h2>
										<?php } ?>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12" align="center">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										...
										<?php
											$query = mysqli_query($conn, "select count(*) as hasil from siswa");
											while ($row = mysqli_fetch_array($query)) {
										?>
										<h2 class="mb-1 number-font"><?php echo $row['hasil']; ?></h2>
										<?php } ?>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12" align="center">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										...
										<?php
											$query = mysqli_query($conn, "select count(*) as hasil from kelas");
											while ($row = mysqli_fetch_array($query)) {
										?>
										<h2 class="mb-1 number-font"><?php echo $row['hasil']; ?></h2>
										<?php } ?>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12" align="center">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										<p class=" mb-1 ">TOTAL MATA PELAJARAN</p>
										<?php
											$query = mysqli_query($conn, "select count(*) as hasil from mapel");
											while ($row = mysqli_fetch_array($query)) {
										?>
										<h2 class="mb-1 number-font"><?php echo $row['hasil']; ?></h2>
										<?php } ?>
