										...
										<table class="table table-bordered text-nowrap w-100" id="example1">
											<thead>
												<tr>
													...
													<th class="wd-29p border-bottom-0">Status Ujian</th>
											...
											<tbody>
												...
												<tr>
													...
													<?php
														$query1 = mysqli_query($conn, "select * from soal where tingkat_kelas='". $_SESSION['tingkat_kelas'] ."' and id_mapel='". $row['id_mapel'] ."' and status='DISETUJUI'");
														$rows = mysqli_num_rows($query1);
														if($rows > 1){
															$query2 = mysqli_query($conn, "select * from nilai where id_mapel='". $row['id_mapel'] ."' and id_siswa='". $_SESSION['id_siswa'] ."'");
													...
													<td>
														<div class="dropdown">
															<button type="button" class="btn btn-primary" data-target="#mulai<?php echo $no; ?>" data-toggle="modal">
																MULAI UJIAN &nbsp;<i class="fe fe-check-square"></i>
															</button>
														</div>
													</td>
													<?php } ?>
												...
												<div class="modal" id="mulai<?php echo $no; ?>">
													<div class="modal-dialog" role="document">
														<form action="ujian.php" method="post">
														<div class="modal-content modal-content-demo">
															<div class="modal-header">MULAI UJIAN <?php echo $row['nama_mapel']; ?></h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
															</div>
															<div class="modal-body">
																<h4>Yakin akan memulai ujian sekarang ? <br><br> <strong>NOTE : Anda akan diarahkan ke halaman ujian dan anda diharuskan menjawab seluruh pertanyaan yang muncul</strong></h4>
															...
															<div class="modal-footer">
																<button class="btn btn-indigo" type="submit" name="mulai">MULAI</button> <button class="btn btn-secondary" data-dismiss="modal" type="button">BATAL</button>
															</div>
														</div>
														</form>
													</div>
