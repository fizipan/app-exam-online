							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title"><button type="button" class="btn btn-primary" data-target="#tambah" data-toggle="modal"><i class="fe fe-plus mr-2"></i>TAMBAH DATA KELAS</button></div>
										<div class="modal" id="tambah">
											<div class="modal-dialog" role="document">
												<form action="" method="post">
												<div class="modal-content modal-content-demo">
													<div class="modal-header">
														<h6 class="modal-title">TAMBAH DATA KELAS</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
													</div>
									...
									<?php 	
											if(isset($_POST['tambah'])){
												...
												if($jurusan=='AKUTANSI'){
													$kode	= 'AK';
												} else if($jurusan=='ADMINISTRASI PERKANTORAN'){
													$kode	= 'AP';
												} else if($jurusan=='PEMASARAN'){
													$kode	= 'PM';
												} else if($jurusan=='MULTIMEDIA'){
													$kode	= 'MM';
												} else if($jurusan=='TEKNIK KOMPUTER JARINGAN'){
													$kode	= 'TKJ';
												}

												$input  		= "insert into kelas (tingkat_kelas, jurusan, kode_kelas, ruang_kelas) values ('$tingkat_kelas','$jurusan','$kode_kelas','$ruang_kelas')";
												$query_input 	= mysqli_query($conn, $input);
												if($query_input) {
												$sukses 		= "<div class='alert alert-success' role='alert'><strong>Sukses ! </strong>Data Kelas <strong>$tingkat_kelas$kode$kode_kelas</strong> berhasil tersimpan di database.</div>";
												} else $gagal 	= "<div class='alert alert-danger' role='alert'><strong>Oh snap! </strong>Tambah Data Kelas  GAGAL ! Mohon periksa kembali</div>".mysqli_error();
											}
											...
											if(isset($_POST['ubah'])){
												...
												$input  		= "update kelas set tingkat_kelas ='" . $tingkat_kelas . "', jurusan ='" . $jurusan . "', kode_kelas ='$kode_kelas', ruang_kelas ='$ruang_kelas' where id_kelas ='" . $id_kelas . "'";
												$query_input 	= mysqli_query($conn, $input);
												if($query_input) {
												$sukses 		= "<div class='alert alert-success' role='alert'><strong>Sukses ! </strong>Data Kelas <strong>$tingkat_kelas$kode$kode_kelas</strong> berhasil dirubah.</div>";
												} else $gagal 	= "<div class='alert alert-danger' role='alert'><strong>Oh snap! </strong>Ubah Data Kelas GAGAL ! Mohon periksa kembali</div>".mysqli_error();
											}
											...
											if(isset($_POST['hapus'])){
												...
												$query_input 	= mysqli_query($conn, $input);
												if($query_input) {
												$sukses 		= "<div class='alert alert-success' role='alert'><strong>Sukses ! </strong>Data Kelas <strong>$kode_kelas</strong> berhasil dihapus.</div>";
												} else $gagal 	= "<div class='alert alert-danger' role='alert'><strong>Oh snap! </strong>Hapus Data Kelas GAGAL ! Mohon periksa kembali</div>".mysqli_error();
											}
									...
									<table class="table table-bordered text-nowrap w-100" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-1p border-bottom-0">Tingkat Kelas</th>
												<th class="wd-29p border-bottom-0">Jurusan</th>
												<th class="wd-10p border-bottom-0">Kode Kelas</th>
												<th class="wd-10p border-bottom-0">Ruang Kelas</th>
										...
										<tbody>
											...
											<div class="modal" id="edit<?php echo $no; ?>">
												<div class="modal-dialog" role="document">
													...
													<div class="modal-content modal-content-demo">
														<div class="modal-header">
															<h6 class="modal-title">EDIT DATA KELAS</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
														</div>
														<div class="modal-body">
															<div class="form-group">
																<label class="form-label">Tingkatan Kelas</label>
															...
															<div class="form-group">
																...
																<div class="row gutters-sm">
																	<div class="col">
																		<select name="jurusan" class="form-control" id="">
																			<option value="AKUTANSI" <?php if($row['jurusan']=='AKUTANSI') echo 'selected="selected"'; ?>>AKUTANSI</option>
																			<option value="ADMINISTRASI PERKANTORAN" <?php if($row['jurusan']=='ADMINISTRASI PERKANTORAN') echo 'selected="selected"'; ?>>ADMINISTRASI PERKANTORAN</option>
																			<option value="PEMASARAN" <?php if($row['jurusan']=='PEMASARAN') echo 'selected="selected"'; ?>>PEMASARAN</option>
																			<option value="MULTIMEDIA" <?php if($row['jurusan']=='MULTIMEDIA') echo 'selected="selected"'; ?>>MULTIMEDIA</option>
																			<option value="TEKNIK KOMPUTER JARINGAN" <?php if($row['jurusan']=='TEKNIK KOMPUTER JARINGAN') echo 'selected="selected"'; ?>>TEKNIK KOMPUTER JARINGAN</option>
																		</select>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="row gutters-sm">
																	<div class="col">
																		<input type="text" class="form-control" name="kode_kelas" value="<?php echo $row['kode_kelas']; ?>" required>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="row gutters-sm">
																	<div class="col">
																		<input type="text" class="form-control" name="ruang_kelas" value="<?php echo $row['ruang_kelas']; ?>" required>
																	</div>
																</div>
															</div>
											...
											<div class="modal" id="hapus<?php echo $no; ?>">
												<div class="modal-dialog" role="document">
													...
													<div class="modal-content modal-content-demo">
														<div class="modal-header">
															<h6 class="modal-title">HAPUS DATA KELAS</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
														</div>
														<div class="modal-body">
															<h5>Yakin akan menghapus data Kelas <strong><?php echo $row['tingkat_kelas']; ?><?php echo $kode; ?><?php echo $row['kode_kelas']; ?></strong> dari sistem ?</h5>
															<input type="hidden" name="id_kelas" value="<?php echo $row['id_kelas']; ?>">
															<input type="hidden" name="kode_kelas" value="<?php echo $row['tingkat_kelas']; ?><?php echo $kode; ?><?php echo $row['kode_kelas']; ?>">
														</div>
														<div class="modal-footer">
